...
Ето два примера как това може да стане:
\begin{enumerate}[1)]
\item
...
В нашите разглеждания, ние няма да се интересуваме коя точно дефиниция на понятието наредена двойка използваме.
Единственото, което е важно за нас е, че е изпълнено характеристичното свойство.
...
\item
  ...
  Аналогично, релацията ``$x$ е роднина на $y$'' е транзитивна.
\item
  \index{бинарна релация!симетрична}
  {\bf симетрична}, ако
  ...
  Аналогично, релацията ``$x$ е брат на $y$'' е симетрична.
\item
  \index{бинарна релация!антисиметрична}
...
\item
  \index{бинарна релация!асиметрична}
  {\bf асиметрична}, ако
  ...
  Аналогично, релацията ``$x$ е родител на $y$'' е асиметрична.
\end{enumerate}
...
%% Тази задача да се сложи при функции
\begin{problem}
...
\section{Релации и класове на еквивалентност}
