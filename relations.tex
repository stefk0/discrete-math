...
% \begin{example}
%   Ако използваме дефиницията на Куратовски за наредени двойки, това означава, че 
%   $\pair{a,b,c} = \pair{a,\pair{b,c}} = \{\{a\},\{a, \pair{b,c}\}\} = \{\{a\}, \}\}$
% \end{example}
...
\Stefan{Да се направи глава за графи след комбинаториката}
...
\item
  ...
  \marginpar{т.е. $\pair{x,y} \in E \implies \pair{y,x} \in E$}
\item
