...
\begin{tabular}{|l|p{4.2cm}|p{4.5cm}|}
  ...
  \hline
  $(\forall x\in A) P(x)$ & за всяко $x$ в областта $A$, $P(x)$ е вярно & съществува $x$ в областта $A$, за което $P(x)$ {\bf не} е вярно \\
  \hline
  $(\exists x\in A) P(x)$ & съществува $x$ в областта $A$, за което $P(x)$ е вярно & $P(x)$ {\bf не} е вярно за всяко $x$ в областта $A$\\
  \hline
\end{tabular}  
\bigskip
