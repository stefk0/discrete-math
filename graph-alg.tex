...
\begin{algorithmic}[1]
  \STATE \COMMENT{Инициализираме $\delta$ и $\pi$}
...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    \STATE \COMMENT{Първо инициализираме $\delta$ и $\pi$}
    \FOR{$i:=1$ to $\nu(G)-1$}
    \FORALL{$(u,v)\in E$}
...
Твърдим, че в масива $\delta$ ще се съдържат търсените минималните пътища, ако няма отрицателни цикли достижими от $s$ в графа.
