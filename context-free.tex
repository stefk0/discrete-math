...
\begin{problem}
  ...
  \item
    $L_6 = \{a^n b a^{2n} b a^{3n}\mid n\geq 0\}$;
  \item
...
\begin{proof}
  ...
  \item
    ...
    Тогава $w = xyuvw$.
    Имаме два случая за $y,v$ - да се състоят от една и съща буква, или 
    да съдържат различни букви.    
  \item
    Разгледайте $w = a^pb^pc^p$.
    Имаме различни случай в зависимост от това от какви букви са съставени 
    $y$ и $v$.
  \item
    \marginpar{ $w = a^pba^pb$ ?}
    Разгледайте $w = a^pb^pa^pb^p$.
  \item
